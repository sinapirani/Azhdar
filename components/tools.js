    ...
    return(
        <div style={{width}} className={` h-screen bg-black flex flex-col justify-center items-center relative overflow-hidden `}>
            ...
            <div className="h-1/2 w-full flex justify-start gap-x-5 pl-7 items-center ">
                ...
                <button className=" z-20 flex justify-center items-center w-1/6 bg-transparent font-extrabold text-white/70 border-2 border-solid border-white/50 text-lg h-14 rounded-md hover:bg-white hover:text-fuchsia-500 duration-75" id="run">
                ...
                <button className=" z-20 flex justify-center items-center w-1/6 font-extrabold text-white/70 text-lg h-14 border-2 border-solid border-white/50 rounded-md hover:bg-white hover:text-fuchsia-500 duration-75" id="run">
