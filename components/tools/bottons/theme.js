...
export default function ThemeChanger(){
    ...
    return(
        <select style={btnStyle} className=" z-20 flex justify-center items-center bg-transparent  font-extrabold text-white/70 text-lg  border-2 border-solid border-white/50 rounded-md hover:bg-white hover:text-fuchsia-500 duration-75" id="run">
