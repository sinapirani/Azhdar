...
export default function Play(){
    ...
    return(
        <button style={btnStyle} onClick={()=>dispatch(play(true))} className=" z-40 flex justify-center items-center bg-transparent font-extrabold text-white/70 border-2 border-solid border-white/50 text-lg rounded-md hover:bg-white hover:text-fuchsia-500 duration-75" id="run">
